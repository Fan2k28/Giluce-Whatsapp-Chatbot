    ...
    async execute(sock, msg, args, context) {
        ...
        try {
            ...
            // Check if replying to a message
                ...
                if (!newsletterJid) {
                    return sock.sendMessage(from, { text: '❌ The replied message is not from a newsletter!\n\nPlease reply to a newsletter message or provide a newsletter JID directly.' });
                }
            } else if (args[0]) {
            ...
            await sock.sendMessage(from, {
                text: `✅ Newsletter JID updated successfully!\n\n` +
            ...
            await sock.sendMessage(from, { text: `❌ Failed to set newsletter JID: ${error.message}` });
        }
    }
};
