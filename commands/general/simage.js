...
const { webp2png, webp2mp4 } = require('../../src/utils/webp2mp4');

module.exports = {
    name: 'simage',
    aliases: ['toimg', 'stickertoimg', 'sticker2img', 'svideo', 'stimg'],
    category: 'general',
    ...
    async execute(sock, msg, args, context) {
        ...
        try {
            ...
            if (!ctxInfo?.quotedMessage) {
                return await sock.sendMessage(from, { text: notStickerMessage });
            }
